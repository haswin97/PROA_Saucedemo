...
public class step {
    ...
    @When("Input in field username {string}")
    public void inputUsername(String username) {
        driver.findElement(By.id("user-name")).sendKeys(username);
    }

    @And("Input in field password {string}")
...
//    }
    ...
    @And("Input in field firstname {string}")
    ...
    @And("Input in field lastname {string}")
    public void inputLastName(String lastname) {
        driver.findElement(By.id("last-name")).sendKeys(lastname);
    }

    @And("Input in field postalcode {string}")
